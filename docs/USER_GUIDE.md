...
python -m td_release_packager package \
    ...
    --properties config/properties/PRD.properties \
...
| `--properties` | Path to environment `.properties` file (required) |
...
Each environment has a `.properties` file in `config/properties/`:
